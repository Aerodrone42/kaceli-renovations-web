      ...
      <section className="container-section">
        <div className="max-w-4xl mx-auto">
          <p className="text-lg mb-8">
            <strong>Kaceli Rénovation Conseil</strong> est votre artisan de confiance à <strong>Francheville</strong> et dans les communes environnantes comme Tassin-la-Demi-Lune, Craponne, Sainte-Foy-lès-Lyon, Oullins, La Mulatière et Charbonnières-les-Bains. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <ServiceCard 
              title="Électricité" 
              description="<strong>Installation électrique</strong> et <strong>dépannage électricité</strong> à <strong>Francheville</strong> par un <strong>électricien qualifié</strong>."
              icon={<Zap size={36} />}
              link="/nos-services#electricite"
            />
            <ServiceCard 
              title="Plomberie" 
              description="<strong>Plombier à Francheville</strong> pour installation, réparation et <strong>dépannage plomberie</strong>."
              icon={<Droplet size={36} />}
              link="/nos-services#plomberie"
            />
            <ServiceCard 
              title="Chauffage" 
              description="Installation et entretien de <strong>chauffages</strong> par votre <strong>chauffagiste à Francheville</strong>."
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2>Services d'électricité à Francheville</h2>
            <p>
              En tant qu'<strong>électricien à Francheville</strong>, <strong>Kaceli Rénovation Conseil</strong> intervient pour tous vos besoins en électricité, 
          ...
          <div>
            <img 
              ...
              alt="Services d'électricité à Francheville" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-16">
          <div className="order-2 md:order-1">
            <img 
              ...
              alt="Services de plomberie à Francheville" 
              className="rounded-lg shadow-lg w-full h-auto"
            />
          </div>
          <div className="order-1 md:order-2">
            <h2>Services de plomberie à Francheville</h2>
            <p>
              Votre <strong>plombier à Francheville</strong>, <strong>Kaceli Rénovation Conseil</strong>, vous propose une gamme complète 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-16">
          <div>
            <h2>Services de chauffage à Francheville</h2>
            <p>
              <strong>Chauffagiste à Francheville</strong>, <strong>Kaceli Rénovation Conseil</strong> vous accompagne dans le choix, 
          ...
          <div>
            <img 
              ...
              alt="Services de chauffage à Francheville" 
              className="rounded-lg shadow-lg w-full h-auto"
            />
          </div>
        </div>
        ...
        <div className="mt-16">
          <h2>Notre expertise à Francheville</h2>
          <p>
            Intervenant régulièrement à <strong>Francheville</strong>, nous connaissons bien les spécificités des habitations de la commune, 
            qu'il s'agisse de maisons anciennes nécessitant des mises aux normes ou de constructions récentes.
          </p>
          <p>
            Notre proximité nous permet d'être réactifs et d'intervenir rapidement dans toute la commune de <strong>Francheville</strong> 
            et ses environs, pour vos urgences comme pour vos projets de rénovation.
          </p>
        </div>
        
        <div className="mt-16 text-center">
          <h2>Votre artisan de proximité à Francheville</h2>
          <p className="max-w-3xl mx-auto mb-8">
            En choisissant <strong>Kaceli Rénovation Conseil</strong> pour vos travaux à <strong>Francheville</strong>, vous optez pour 
